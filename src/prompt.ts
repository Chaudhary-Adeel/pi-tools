...
- spawn_subagents runs in the background by default — you get an immediate acknowledgment and should keep working (implement the parts that don't depend on their findings, or continue other work) rather than sitting idle. You'll get a message here when the batch completes. Only pass background: false when you genuinely need the results before taking your next step.
